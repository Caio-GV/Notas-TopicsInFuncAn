...
\[\dv{u}{t}(x(t),t) = \pdv{u}{t}\pdv{y}{t} + \pdv{u}{x}\pdv{x}{t} = u_t + u_xu = 0\]
...
And for all points in this curve $u(x,t) = u_0(x_0)$. \

For convenience’s sake, we will choose this as our initial curve $u_0$:

\includegraphics[scale=0.3]{graphs/desmos-graph.png}

Using the initial condition given by $u_0$, the characteristic curves are:

\includegraphics[scale=0.3]{graphs/carac.png}
